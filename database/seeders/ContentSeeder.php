    ...
    public function run(): void
    {
        ...
        $cases = [
            ['title' => 'Zirkonyum kaplama ile gülüş yenileme', 'Estetik Diş Hekimliği',
             'before' => '/images/gallery/case1_before.jpg',
             'after'  => '/images/gallery/case1_after.jpg'],
            ['title' => 'Ağır çürük vakasında tam ağız rehabilitasyonu', 'Estetik Diş Hekimliği',
             'before' => '/images/gallery/case2_before.jpg',
             'after'  => '/images/gallery/case2_after.jpg'],
            ['title' => 'Ön diş kaplama ile estetik gülüş', 'Estetik Diş Hekimliği',
             'before' => '/images/gallery/case3_before.jpg',
             'after'  => '/images/gallery/case3_after.jpg'],
            ['title' => 'Diş çürüğü sonrası zirkonyum kaplama', 'Estetik Diş Hekimliği',
             'before' => '/images/gallery/case4_before.jpg',
             'after'  => '/images/gallery/case4_after.jpg'],
            ['title' => 'Tam ağız restorasyonu', 'Estetik Diş Hekimliği',
             'before' => '/images/gallery/case5_before.jpg',
             'after'  => '/images/gallery/case5_after.jpg'],
            ...
            ['title' => 'Estetik lamina veneer uygulaması', 'Estetik Diş Hekimliği',
             'before' => '/images/gallery/ba1_before.jpg',
             'after'  => '/images/gallery/ba1_after.jpg'],
            ['title' => 'Zirkonyum köprü ile diş tamamlama', 'Estetik Diş Hekimliği',
             'before' => '/images/gallery/ba2_before.jpg',
             'after'  => '/images/gallery/ba2_after.jpg'],
            ['title' => 'Kapsamlı gülüş tasarımı', 'Estetik Diş Hekimliği',
             'before' => '/images/gallery/ba3_before.jpg',
             'after'  => '/images/gallery/ba3_after.jpg'],
            ...
            ['title' => 'Alt-üst çene estetik düzenleme', 'Estetik Diş Hekimliği',
             'before' => '/images/gallery/ba5_before.jpg',
             'after'  => '/images/gallery/ba5_after.jpg'],
            ...
            ['title' => 'Tam ağız estetik yenileme', 'Estetik Diş Hekimliği',
             'before' => '/images/gallery/ba7_before.jpg',
             'after'  => '/images/gallery/ba7_after.jpg'],
        ];
