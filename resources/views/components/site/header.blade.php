    ...
    <div class="hidden bg-teal-700 text-white/90 lg:block">
        <div class="container-x flex h-10 items-center justify-between text-[13px]">
            ...
            <div class="flex items-center gap-4">
                <span class="text-white/70">Pzt–Cmt {{ \App\Models\Setting::get('working_hours')['Pazartesi - Cuma'] ?? '09:00 - 19:00' }}</span>
    ...
    >
        <nav class="container-x flex h-[72px] items-center justify-between">
            ...
            <a href="{{ route('home') }}" class="flex items-center gap-2.5">
                <span class="flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-to-br from-teal-500 to-teal-700 text-lg text-white shadow-lg shadow-teal-500/30">
