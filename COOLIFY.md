# Dentila Diş Polikliniği — Coolify Deploy Notları
...
- Veritabanı: `dentila_db` · Kullanıcı: `dentila` · Şifreyi kaydedin
...
```
APP_NAME=Dentila Diş Polikliniği
APP_ENV=production
...
MAIL_FROM_ADDRESS=randevu@dentila.com
MAIL_FROM_NAME="Dentila Diş Polikliniği"
...
- Demo giriş: **admin@dentila.com / password** (seed ile oluşur — production'da değiştirin!)
